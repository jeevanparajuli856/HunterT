...
func Start(cfg config.BundleCommandConfig) (*Client, error) {
...
func (c *Client) LoadBundle(bundlePath string) (*config.BundleInfo, error) {
...
func (c *Client) InspectBundle(bundlePath string) (*config.BundleInfo, error) {
	request := map[string]any{"op": "inspect_bundle"}
	if strings.TrimSpace(bundlePath) != "" {
		request["bundle_path"] = bundlePath
	}
